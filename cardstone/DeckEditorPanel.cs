...
namespace stonekart
{
    class DeckEditorPanel : DisplayPanel
    {
        ...
        public DeckEditorPanel()
        {
            ...
            Point p = new Point(100, MainFrame.FRAMEHEIGHT/2);
            ...
            Portraits.Add(arrowRight, new PortraitInfo(new Rectangle(new Point(MainFrame.FRAMEWIDTH - arrowRight.Width * 2, 
                MainFrame.FRAMEHEIGHT / 3 + arrowRight.Height / 2), new Size(arrowRight.Width, arrowRight.Height)), null));
            
            Portraits.Add(arrowLeft, new PortraitInfo(new Rectangle(new Point(32,  MainFrame.FRAMEHEIGHT / 3 + arrowLeft.Height/2),
                new Size(arrowLeft.Width, arrowLeft.Height)), null));

            Portraits.Add(save, new PortraitInfo(new Rectangle( new Point(MainFrame.FRAMEWIDTH - 128, 50),  new Size(save.Width, save.Height)), null));
        ...
        private static void vanGogh(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString(search, muhFont, muhBrush, 
                new PointF(MainFrame.FRAMEWIDTH/2, MainFrame.FRAMEHEIGHT/3));
